$(document).ready(function () {
    ...
    title.text('Martin' + "@" + osName + ": ~ (redis-cli)");
    ...
    function help(arg) {
        ...
        if (hasArgs(arg)) {
            ...
            printf(" Redis bash with SpringBoot by <a href='https://java2e.com' class='kw_b'>Martin</a>, version v0.0.1 - Snapshot \n");
    ...
    $('#inputPaste').mousedown(function (e) {
        if (3 == e.which) {
